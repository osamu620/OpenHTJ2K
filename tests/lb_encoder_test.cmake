...
# Each chain: encode (default LB), decode (default LB), compare to original.
...
add_test(NAME lb_enc_lossless
    COMMAND open_htj2k_enc -i ${CONFORMANCE_DATA_DIR}/kodim23.ppm
            -o lb_kodim23lossless.j2c Creversible=yes)
add_test(NAME lb_dec_lossless
    COMMAND open_htj2k_dec -i lb_kodim23lossless.j2c -o lb_kodim23lossless.ppm)
...
add_test(NAME lb_enc_lossy
    COMMAND open_htj2k_enc -i ${CONFORMANCE_DATA_DIR}/kodim23.ppm
            -o lb_kodim23lossy.j2c Qfactor=90)
add_test(NAME lb_dec_lossy
    COMMAND open_htj2k_dec -i lb_kodim23lossy.j2c -o lb_kodim23lossy.ppm)
